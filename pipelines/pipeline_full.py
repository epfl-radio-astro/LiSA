...
#===== input filepaths  =====
filepath_datacube       = "/scratch/foureste/sky_full_v2.fits"
filepath_continuumimage = None

#===== output directory  =====
output_directory = "/scratch/etolley/SDC2/full_output_3Ddenoise_fixed/" 
...
lkh_threshold = 12
denoised_file_name          = "{1}/{0}domains/".format(        n_domains,    output_directory)
...
denoised_file_name+= "sky_full_denoised3D"
...
cutout_dim = (200, 60, 30, 1)
wz = int(cutout_dim[0]/2)
wy = int(cutout_dim[1]/2)
wx = int(cutout_dim[2]/2)
